...
class Trade():
    ...
    def now_trade(self, trade_id: str, order_type: str, long_or_short: str, enter_or_exit: str, price: float = 0.00, stop_limit_price: float = 0.00) -> dict:
    ...
    def instrumnt(self, symbol: str, quantity: int, asset_type: str, sub_asset_type: str = None, order_leg_id: int = 0) ->dict:
        
        leg = self.order['orderLegCollection'][order_leg_id]

        leg['instrumnt']['symbol'] = symbol
        leg['instrumnt']['asset_type'] = asset_type
    ...
    def good_till_cancel(self, cancel_time: datetime) -> None:
        ...
        self.order['duration'] = 'Good_Till_CANSEL'
        self.order['cancel_time'] = cancel_time.isoformat()
    ...
    def add_take_profile(self, profit_size: float, percenatge: bool = False) -> bool:
